...
try:
    from sorveglianza_avanzata import render_followup_sorveglianza_avanzato
except ImportError:
...
try:
    from chirurgia_avanzata import render_followup_chirurgia_avanzato
except ImportError:
...
try:
    from radioterapia_avanzata import render_followup_radioterapia_avanzato
except ImportError:
